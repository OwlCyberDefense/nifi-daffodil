...
@WritesAttributes({
    ...
    @WritesAttribute(attribute = "daffodil.error.message.i", description = "For flow files routed to failure, there will be i many errors generated by Daffodil."),
    @WritesAttribute(attribute = "daffodil.warn.message.i", description = "For flow files routed to failure, there will be i many warnings generated by Daffodil.")})
